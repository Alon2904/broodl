    ...
    return (
        <div className='flex flex-col gap-2'>
            <div className='grid grid-cols-5 gap-4'>
                ...
                <p className={'text-center col-span-3 capitalized whitespace-nowrap textGradient ' + fugazOne.className}>{selectedMonth}, {selectedYear}</p>
                <button onClick={() => {
                    handleIncrementMonth(+1)
